<template>
    <div class="access-my-account">
        ...
        <ModalAccessByHardware
            v-model="modalAccessByHardwareIsOpen"
        ...
        <ModalEnterAccountId
            ...
            :signing-options="signingOptions"
...
export default createComponent({
    ...
    setup(props, context) {
        const signingOptions: Wrapper<SigningOpts | null> = value(null);
        ...
        function handleAccessByHardwareSubmit(
            newPublicKey: string,
            newSigningOptions: SigningOpts
        ) {
            publicKey.value = newPublicKey;
            signingOptions.value = newSigningOptions;

            modalAccessByHardwareIsOpen.value = false;
            setTimeout(() => {
